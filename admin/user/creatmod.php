...
if(!mysqli_fetch_row(mysqli_query($dbc, $query))) {
    $query = "INSERT INTO st_users VALUES('".$_REQUEST['uname']."','".md5("password")."','M',0,'Moderator')" or die("Error");
...
else die("<span style='color: #600'>User name is already there: Entering a new instant is skipped</span>");
?>